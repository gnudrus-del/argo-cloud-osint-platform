...
Per un'analisi operativa del principio di proporzionalità e delle regole di ingaggio si rinvia al documento [`docs/RESPONSIBLE_USE.md`](RESPONSIBLE_USE.md).
