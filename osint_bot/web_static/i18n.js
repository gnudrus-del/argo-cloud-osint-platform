...
(function () {
  ...
  var DICT = {
    ...
    "inv.lead": { en: "Enter every data point you have on the target. Argo searches and links it all together, in a single investigation.", it: "Inserisci tutti i dati che hai sul target. Argo li cerca e li collega insieme, in un'unica indagine." },
    "inv.fillHint": { en: "Fill in only the fields you know. A full aggressive search (every available tool) starts automatically for each value you enter, all together.", it: "Compila solo i campi che conosci. Ogni ricerca aggressiva completa (tutti i tool disponibili) parte in automatico per ciascun dato inserito, tutte insieme." },
    "inv.section.username": { en: "Username (one or more platforms)", it: "Username (una o più piattaforme)" },
    "inv.section.media": { en: "Image / Video", it: "Immagine / Video" },
    ...
    "inv.legend.persona": { en: "Person / Name", it: "Persona / Nome" },
    "inv.legend.domain": { en: "Domain / Company", it: "Dominio / Azienda" },
    "inv.legend.wallet": { en: "Crypto wallet", it: "Wallet crypto" },
    ...
    "inv.runAll": { en: "🚀 Start full investigation", it: "🚀 Avvia indagine completa" },
    "inv.planOnly": { en: "Plan preview only", it: "Solo anteprima del piano" },
    "inv.combined.emptyError": { en: "Fill in at least one field before starting.", it: "Compila almeno un campo prima di avviare." },
